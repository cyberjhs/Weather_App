...
let weather = {
    ...
    displayWeather: function(data, DayNumber) {
        ...
        // DAY 5
        let date5 = data.list[31].dt_txt;
        const icon5 = data.list[31].weather[0].icon;
        const description5 = data.list[31].weather[0].description;
        const temp5 = data.list[31].main.temp;
        const humidity5 = data.list[31].main.humidity;
        const speed5 = Math.round((Number(data.list[31].wind.speed) * 3.6) * 100) / 100;
        const pop5 = data.list[31].pop;
        const main5 = data.list[31].weather[0].main;
        ...
        let arr5 = dateList(date5);
        let dw = new Date(`${arr5[0]} ${arr5[1]}, ${arr5[2]}`);
        ...
        switch(DayNumber) {
            ...
            case 4:
                ...
                break;
            case 5:
                modify(day5, arr5, icon5, temp5, description5, pop5, humidity5, speed5);
                CardBackground(main5);
                break;    
        }
        ...
        document.querySelector(".Five img").src = "https://openweathermap.org/img/wn/" + icon5 + ".png";
        document.querySelector("#d5").innerText = day5.substr(0, 3);
        document.querySelector("#t5").innerText = Math.round(Number(temp5)) + "°C";
...
document.querySelector(".Five").addEventListener("click", function() { weather.displayWeather(D , 5) });
